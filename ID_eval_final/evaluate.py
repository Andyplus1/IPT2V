...
def main():
    ...
    # change name
    if os.path.isdir(args.videos_path):
        video_name = os.path.basename(os.path.normpath(args.videos_path))
    else:
        video_name = os.path.splitext(os.path.basename(args.videos_path))[0]

    my_VBench.evaluate(
        videos_path = args.videos_path,
        name = f"{video_name}_Vbench",
